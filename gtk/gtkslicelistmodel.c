                                  ...
                                  guint           *end)
{
  ...
  if (!GTK_IS_SECTION_MODEL (self->model))
    ...
    {
      gtk_section_model_get_section (GTK_SECTION_MODEL (self->model), position + self->offset, start, end);
                                          ...
                                          gpointer         user_data)
{
  ...
  gtk_section_model_sections_changed (GTK_SECTION_MODEL (self), start, end);
}
